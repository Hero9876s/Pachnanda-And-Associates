          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300 text-lead">
                  <p>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-transparent dark:border-slate-800 transition-colors duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="text-center p-6 bg-blue-50 dark:bg-slate-800 rounded-xl">
                  <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">25+</div>
                  <div className="font-semibold text-gray-900 dark:text-white mb-2">Years of Service</div>
                ...
                <div className="text-center p-6 bg-blue-50 dark:bg-slate-800 rounded-xl">
                  ...
                  <div className="font-semibold text-gray-900 dark:text-white mb-2">Clients Served</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="text-center p-6 bg-blue-50 dark:bg-slate-800 rounded-xl">
                  ...
                  <div className="font-semibold text-gray-900 dark:text-white mb-2">Ethical Practice</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="mt-12 bg-gray-50 dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-transparent dark:border-slate-800 transition-colors duration-300">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                Deep Understanding, Practical Solutions
              </h3>
              <p className="text-lead text-gray-700 dark:text-gray-300">
