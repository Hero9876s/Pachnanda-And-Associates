    ...
    <section className="section-padding">
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">2. Use of Website</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">3. Professional Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">4. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">5. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">6. Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">7. Modifications to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">8. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-corporate-dark mb-4">9. Contact Information</h2>
            <p>
