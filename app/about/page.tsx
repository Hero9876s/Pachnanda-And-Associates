          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg border-l-4 border-corporate-blue">
                  <h3 className="font-semibold text-corporate-dark mb-2">Our Mission:</h3>
                  <p>
      ...
      <section className="bg-gradient-to-r from-gray-50 to-blue-50 section-padding">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-t-4 border-corporate-blue">
              <h3 className="text-xl font-semibold text-corporate-dark mb-3">Our Expertise</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-t-4 border-purple-600">
              <h3 className="text-xl font-semibold text-corporate-dark mb-3">Our Approach</h3>
              <p className="text-gray-600">
                Client-centric, transparent, and ethical practices with fixed pricing and no hidden charges.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-t-4 border-indigo-600">
              <h3 className="text-xl font-semibold text-corporate-dark mb-3">Our Commitment</h3>
              <p className="text-gray-600">
  ...
  <div className="container-custom">
    <div className="bg-corporate-blue text-white p-8 rounded-lg shadow-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          href="/founders-story"
          className="bg-white text-corporate-blue p-6 rounded-lg hover:bg-blue-50 transition-colors text-center"
        >
